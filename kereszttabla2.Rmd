...
# Kereszttáblaelemzés II.
## Folytatás, újabb példával
...
A kérdés értelemszerűen: összefügg-e a populációban, amelyből a mintát vettük, az angol és a francia nyelv ismerete, és ha igen, hogyan?

A nullhipotézisünk ismét az, hogy nem függ össze: a két nyelv ismerete független egymástól
A javasolt ellenhipotézis, hogy a két nyelv ismerete összefügg egymással.
...
$e_{11}=\frac{50\times100}{200}=25$  
$e_{12}=\frac{50\times40}{200}=10$  
$e_{13}=\frac{50\times60}{200}=15$  
$e_{21}=\frac{80\times100}{200}=40$  
stb.  
...
A fenti próba igaz nullhipotézis esetén, tehát, ha a két változó egymástól független, $df = (s-1)\times(o-1)=(3-1)\times(3-1)=4$ szabadságfokú &chi;&sup2; eloszlást követ. Az eloszlás táblázata alapján az 5%-os szignifikanciaszintnek a $\chi^2_{0,95;4}=9,49$ határérték felel meg.
...
Nézzük, milyen erős az összefüggés:
...
$$Cramer V = \sqrt{\frac{\chi^2}{N\times\left(min\left(s;o\right)-1\right)}}=\sqrt{\frac{9,571}{200\times(3-1)}}=0,155$$
...
Nézzük először a 2. sor 2. oszlopában lévő cellával: a 30 személy a 20 személlyel $30\times 20=600$ konkordáns párt alkot. A 2. sor 3. oszloppal $30\times 30 = 900$ párt alkotnak, stb.
Ez összesen: $30\times (20+30+10+20)=2400$ konkordáns pár
...
Ez összesen $10\times (30+20) = 500$ további konkordáns párt jelent.  
...
tab_obs %>%
  ...
  set_markdown_contents(1, 1, "")
```
Ez további $30\times (10+20)=900$ konkordáns pár.
...
$10\times (30+20+40+10)=1000$ <br>
$10\times (30+40)=700$ <br>
$30\times (40+10)=1500$ <br>
$20\times 40 = 800$ <br>
Összesen: $1000+700+1500+800=4000$  <br>

A Gamma képlete a következő:
$$\gamma = \frac{konkordáns párok száma - diszkordáns párok száma}{konkordáns párok száma + diszkordáns párok száma}$$
...
$r_{11}^{(a)}=\frac{30-25}{\sqrt{25\times \left(1-\frac{50}{200}\right)\times\left(1-\frac{100}{200}\right)}}=1,63$  
$r_{12}^{(a)}=\frac{10-10}{\sqrt{10\times \left(1-\frac{50}{200}\right)\times\left(1-\frac{40}{200}\right)}}=0$  
$r_{13}^{(a)}=\frac{10-15}{\sqrt{15\times \left(1-\frac{50}{200}\right)\times\left(1-\frac{60}{200}\right)}}=-1,78$  
$r_{21}^{(a)}=\frac{30-40}{\sqrt{40\times \left(1-\frac{80}{200}\right)\times\left(1-\frac{100}{200}\right)}}=0$  
stb.  
