...
De a fenti képlet helyett használhatjuk a sima függetlenségvizsgálatnál is használt &chi;&sup2; próbát is: kiszámítjuk az $e_{ij}$ értékeket, majd az $e_{ij}$ és $m_{ij}$ értékek alapján kiszámítjuk a $\chi^2$ próbát a $2\ast k$ méretű kereszttáblára, ahol $k$ a változó kategóriáinak száma.
